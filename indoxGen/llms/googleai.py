...
class GoogleAi:
    def __init__(self, api_key, model="gemini-1.5-flash-latest", prompt_template=""):
        """
        Initializes the GoogleAI API with the specified API key and model.

        Args:
            api_key (str): The API key for Google AI.
            model (str): The Google Gemini model version.
